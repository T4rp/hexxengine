// upstream: https://github.com/dimforge/rapier/blob/0b7c3b34ecacff70070cd697fe7a51638855e5ba/src/utils/mod.rs
...
use rapier3d::{na, parry};

use na::{RealField, Vector2};
use parry::bounding_volume::BoundingVolume;
use parry::query::details::ShapeCastOptions;
use parry::query::{DefaultQueryDispatcher, PersistentQueryDispatcher};
use rapier3d::geometry::{ColliderHandle, ContactManifold, Shape, ShapeCastHit};
use rapier3d::math::{Pose, Real, Vector};
use rapier3d::pipeline::{QueryFilterFlags, QueryPipeline, QueryPipelineMut};
use rapier3d::utils;
